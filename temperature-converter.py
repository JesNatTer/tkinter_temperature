...
root.config(bg="red")
#  cannot resize the program's width and height
root.resizable(0, 0)

#  label and input field for celsius
...
#  label and input field for fahrenheit
...
#  functions to select C to F, or F to C
def selection1():
...
#  Function to convert C to F, or F to C, and error for invalid input
def convert_temp():
    try:
...
#  button to clear inputs and result
